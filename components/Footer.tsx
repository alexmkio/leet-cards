...
export default function Footer() {
  return (
    <footer className="bg-gray-50 flex justify-between items-center p-2 md:px-40 dark:bg-gray-900 dark:bg-opacity-90">
      ...
      <div className="w-12 md:w-16">
        <a href="https://github.com/alexmkio/leet-cards" target="_blank" rel="noreferrer">
          <svg xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 duration-300 ease-in-out hover:text-green-300" fill="none" viewBox="0 0 1024 1024">
