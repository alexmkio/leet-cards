...
export default function Header() {
  ...
  return (
    <header className="flex flex-col md:flex-row md:justify-between items-center p-1 md:p-2 md:px-40 bg-gray-50 shadow-md sticky top-0 z-50 dark:bg-gray-900 dark:bg-opacity-80">
      {logo}
