      ...
      <div className="flex justify-center">
        <article className="h-full w-7/12 flex flex-col">
          ...
          <div className="flex justify-center pt-8">
            <Link href='/study'>
              <a>
                <button className="flex items-center text-xl rounded-full py-3 px-9 transition duration-500 ease-in-out bg-red-300 hover:bg-red-400 transform hover:scale-110 hover:shadow-2xl hover:text-blueGray-100">
                  Enter&nbsp;
