...
export default function EditPost({ card }: Props) {
  ...
  return (
    <>
      ...
      <h2 className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl pt-8 text-center capitalize">Edit a flash card</h2>
      <div className="flex flex-col items-center">
        ...
        <form className="flex flex-col justify-center w-11/12 md:w-8/12 lg:w-6/12 xl:w-5/12">
          <label className="text-lg pt-8 md:pt-12 text-center" htmlFor="answer">Answer:</label>
          <textarea
          ...
          <div className="flex justify-center py-6 md:py-12">
            <button onClick={(event) => putFlashCard(event)} className="flex items-center text-lg md:text-xl rounded-full py-3 px-9 transition duration-500 ease-in-out bg-red-300 hover:bg-red-400 transform hover:scale-110 hover:shadow-2xl hover:text-blueGray-100">
              Edit card&nbsp;
